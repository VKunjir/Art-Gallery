...
const Login = () => {
    ...
    return (
        <div className='text-white h-[100vh] flex justify-center items-center bg-cover' style={{"backgroundImage": "url('https://tse4.mm.bing.net/th?id=OIP.x-Rynim6InFmmkVHsZOqLQHaEK&pid=Api&P=0&h=180')"}}>
