    ...
    <div className='m-12 flex flex-row w-[90%] justify-evenly'>
      ...
      <div className='bg-white mb-3 rounded-[10px] p-3 flex flex-col w-96 justify-evenly'>
        ...
        <div className="flex mt-4 flex-col items-center">
          <div onClick={handelWishlist} className='text-xl bg-black text-white p-2 rounded-lg w-[200px] cursor-pointer mb-3'>
            ❤️ Add to Wishlist
          </div>
          <div onClick={handelCart} className='flex items-center justify-center text-xl bg-black text-white py-2 px-4 rounded-lg w-[200px] cursor-pointer transition duration-300 ease-in-out transform hover:scale-105 mb-3'>
            Add to Cart
          </div>
